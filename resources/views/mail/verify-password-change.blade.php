...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>You have requested to change your password. To confirm this change, please click the button below:</p>
            
            <div style="text-align: center;">
                <a href="{{ $verifyUrl }}" class="button">Verify Password Change</a>
            </div>
            ...
            <p><strong>If you did not request this change</strong>, please ignore this email. Your password will remain unchanged.</p>
        </div>
        <div class="footer">
