...
<style>
    ...
    <div class="subscription-container mb-5">
        <div class="subscription-header">
            ...
            <p>Select the perfect plan for your needs. All plans include a 14-day free trial.</p>
        </div>
        ...
        <div class="plans-container">
            ...
            <div class="plan">
                ...
                <div class="plan-price">${{ number_format($month->price ) }}<span>/per month</span></div>
                    ...
                    <p class="plan-features">description: {{ $month->description }}</p>
                
                <button class="plan-button outline"><a href="#" class="text-decoration-none" style="color: #00b22d;">Get Started</a></button>
            </div>
        ...
        <div class="plans-container">
            ...
            <div class="plan">
                ...
                <div class="plan-price">${{ number_format($year->price ) }}<span>/per year</span></div>
                    ...
                    <p class="plan-features">description: {{ $year->description }}</p>
