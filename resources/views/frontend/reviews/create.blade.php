...
@section('title', 'Submit a Review - EMS')
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="text-white display-4 fw-bold mb-3">Submit a Review</h1>
                    <p class="text-white lead mb-0">Share your experience with EMS</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <p class="text-muted mb-4">
                                Thank you for taking the time to share your feedback! Your review will be reviewed by our team before being published.
                            </p>
                            ...
                            <form action="{{ route('reviews.store') }}" method="POST">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    ...
                                    <button type="submit" class="btn" style="background: linear-gradient(135deg, var(--primary-color), var(--primary-dark)); color: white; border: none; font-weight: 600;">
