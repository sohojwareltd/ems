            ...
            <div class="col-lg-6 mb-4">
                <div class="product-gallery">
                    ...
                    <div class="main-image-container" id="mainImageContainer">
                        <img src="{{ asset('storage/' . $product->thumbnail) }}" class="main-image" id="mainImage"
                            alt="{{ $product->name }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-top pt-3">
                            <div class="d-flex gap-2">
                                <a href="{{ route('model.index', ['qualiification' => $product->qualiification->id]) }}"
                                    class="btn btn-outline-primary btn-sm">
                                    {{ $product->qualiification->title ?? '' }}
                                </a>
                                <a href="{{ route('model.index', ['examboard' => $product->examboard->id]) }}"
                                    class="btn btn-outline-info btn-sm">
                                    {{ $product->examboard->title ?? '' }}
                                </a>
                                <a href="{{ route('model.index', ['resource' => $product->resource->id]) }}"
                                    class="btn btn-outline-success btn-sm">
                                    {{ $product->resource->title ?? '' }}
                                </a>
                                <a href="{{ route('model.index', ['subject' => $product->subject->id]) }}"
                                    class="btn btn-outline-success btn-sm">
            ...
            function updateVariantDisplay() {
                ...
                if (selectedVariant.length === 0) {
                    ...
                    if (isOutOfStock) {
                        ...
                        $('#add-to-cart-form button[type="submit"]').prop('disabled', false).html(
