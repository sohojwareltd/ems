    ...
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist
            ->schema([
                ...
                InfoComponents\Section::make('Recipients List')
                    ->schema([
                        InfoComponents\RepeatableEntry::make('recipients')
                            ->hiddenLabel()
                            ->schema([
                                ...
                                InfoComponents\TextEntry::make('status')
                                    ->label('Status')
                                    ->getStateUsing(function (EmailRecipient $record): string {
                                        return $record->hasReplied() ? 'Replied' : 'Pending';
                                    })
                                    ->badge()
                                    ->color(fn (string $state): string => match ($state) {
                                        'Replied' => 'success',
